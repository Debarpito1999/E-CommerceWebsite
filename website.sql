...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3240036164ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=website&table=wp_options">`website`.`wp_options`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=website&table=wp_actionscheduler_actions">`website`.`wp_actionscheduler_actions`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=epiz_27682460_project&table=wp_options">`epiz_27682460_project`.`wp_options`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=epiz_27682460_project&table=wp_links">`epiz_27682460_project`.`wp_links`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=epiz_27682460_project&table=wp_comments">`epiz_27682460_project`.`wp_comments`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2175456553677358437a495d50457627">
...
<div id="topmenucontainer" class="menucontainer">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="epiz_27682460_project" targettable="wp_links">
            ...
            Database
                            : <span>epiz_27682460_project</span>
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `wp_links`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="epiz_27682460_project" targettable="wp_comments">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `wp_comments`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="epiz_27682460_project" targettable="wp_options">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `wp_options`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="website" targettable="wp_actionscheduler_actions">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `wp_actionscheduler_actions`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="website" targettable="wp_options">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
